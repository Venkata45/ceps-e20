...
import { FiUsers, FiArrowLeft, FiSearch, FiFilter, FiDownload, FiLock, FiUnlock, FiMail } from 'react-icons/fi';
...
const StudentsDetailPage = () => {
    ...
    const filteredStudents = students.filter(student => {
        ...
        const matchesFilter = filterStatus === 'all' ||
            (filterStatus === 'active' && !student.isLocked) ||
            (filterStatus === 'locked' && student.isLocked);
    ...
    const exportToCSV = () => {
        const csvContent = [
            ['Name', 'Email', 'Student ID', 'Department', 'Status', 'Joined Date'].join(','),
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-blue-600">Student Management</span>
                        </div>
                        <h1 className="text-5xl font-black text-slate-900 tracking-tighter">All Students</h1>
                        <p className="mt-4 text-slate-500 font-medium max-w-md leading-relaxed italic border-l-2 border-slate-100 pl-4">
                            Complete overview of all registered students in the system
                        </p>
                    </div>
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={exportToCSV}
                        className="px-6 py-3 rounded-xl font-bold text-white bg-blue-600 hover:bg-blue-700 transition-all flex items-center gap-2 shadow-lg shadow-blue-600/30"
                    >
                    ...
                    <table className="w-full">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-xs font-black text-slate-700 uppercase tracking-wider">Student ID</th>
                            ...
                            {loading ? (
                                ...
                                filteredStudents.map((student) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold ${student.isLocked
